...
import { User, CalendarCheck2, MessageSquare, ClipboardList, ShieldCheck, Award, Building2, Star } from "lucide-react";
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
      ...
      <Card className="pt-6 pb-0 group">
        ...
        <CardContent className="flex items-center justify-between">
          ...
          <Award className="text-primary/30 group-hover:text-primary/60 transition-colors" size={90} />
        </CardContent>
      </Card>
      <Card className="pt-6 pb-0 group">
        <CardHeader>

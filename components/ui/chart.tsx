...
const COLORS = ["#6366f1", "#f59e42", "#10b981", "#ef4444", "#3b82f6", "#a78bfa", "#f472b6", "#facc15", "#34d399", "#60a5fa"];

export function Chart({ type, labels, data, title }: ChartProps) {
  // Prepare data for recharts
  const chartData = labels.map((label, idx) => ({ name: label, value: data[idx] }));

  return (
    <Card className="p-4 flex flex-col items-center justify-center">
      {title && <div className="font-semibold mb-2 text-center w-full">{title}</div>}
